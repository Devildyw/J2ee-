...
import org.cuit.vo.LayerPhoto;
import org.cuit.vo.LayerPhotoData;
...
public class UserController {
    ...
    public String userLayerDonate(@PathVariable String uid){
        ...
        layerPhotos.add(new LayerPhotoData().setAlt("图1").setPid(1).setSrc("/images/donate/alipay.png").setThumb(""));
        layerPhotos.add(new LayerPhotoData().setAlt("图2").setPid(2).setSrc("/images/donate/wechat.jpg").setThumb(""));
        ...
        CLUtils.print(donateJsonString);
